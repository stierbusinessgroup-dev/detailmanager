-- Minimal CRM Migration - Just add fields and create table
-- Run this first to get CRM working, then we can add triggers later
...
-- Create functions (simple versions, no complex logic)
...
SELECT 'Minimal CRM setup complete!' as status;
