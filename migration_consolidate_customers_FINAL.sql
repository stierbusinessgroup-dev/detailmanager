-- Migration: Consolidate CRM Tables (FINAL VERSION)
-- Description: Adds CRM fields to customers table and creates supporting infrastructure
-- Author: DetailManager
-- Date: 2026-01-22
-- NOTE: This version drops old CRM triggers/functions first to prevent conflicts

-- ============================================================================
-- STEP 0: Clean up old CRM functions and triggers
-- ============================================================================
...
COMMENT ON FUNCTION sync_customer_purchase_data IS 'Automatically updates customer stats when sales are completed';
