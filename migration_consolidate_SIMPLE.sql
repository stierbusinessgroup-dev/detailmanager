-- Migration: Simple CRM Consolidation
-- Description: Adds CRM fields to customers table - minimal approach
-- Author: DetailManager
-- Date: 2026-01-29

-- ============================================================================
-- STEP 1: Add CRM fields to customers table (no cleanup, just add)
-- ============================================================================

DO $$
BEGIN
    -- Add all CRM fields one by one
...
-- ============================================================================
-- STEP 2: Create CRM interactions table (if not exists)
-- ============================================================================
...
-- ============================================================================
-- STEP 3: Create NEW CRM functions (with OR REPLACE to overwrite old ones)
-- ============================================================================
...
SELECT 'CRM consolidation completed successfully! 🎉' as status;
