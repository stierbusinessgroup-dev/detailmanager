-- Migration: Create Products/Inventory Table
...
CREATE INDEX IF NOT EXISTS idx_products_vendor ON public.products USING btree (vendor) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS idx_inventory_transactions_user_id ON public.inventory_transactions USING btree (user_id) TABLESPACE pg_default;
